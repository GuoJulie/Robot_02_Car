...
def generate_launch_description():
    ...
    map_yaml_path = LaunchConfiguration('map',default=os.path.join(juliebot_navigation2_dir,'maps','juliebot_map_01.yaml'))
    nav2_param_path = LaunchConfiguration('params_file',default=os.path.join(juliebot_navigation2_dir,'config','nav2_params.yaml'))
