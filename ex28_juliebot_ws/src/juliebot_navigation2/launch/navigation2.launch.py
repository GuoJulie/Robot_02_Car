...
def generate_launch_description():
    ...
    use_sim_time = LaunchConfiguration('use_sim_time', default='false') # not use gazebo -> sim environment -> get time through topic "/clock", not system time -> use_sim_time=true
